 ...
 *  @author Kevin Wayne
 */
public class BreadthFirstPathsWL {
     ...
     */
    public BreadthFirstPathsWL(DigraphWL G, int s) {
     ...
     */
    public BreadthFirstPathsWL(DigraphWL G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++)
    ...
    private void bfs(DigraphWL G, int s) {
    ...
    private void bfs(DigraphWL G, Iterable<Integer> sources) {
        Queue<Integer> q = new Queue<Integer>();
        for (int s : sources) {
            marked[s] = true;
            distTo[s] = 0;
    ...
    private boolean check(DigraphWL G, int s) {
    ...
    public static void main(String[] args) {
        In in = new In(args[0]);
        DigraphWL G = new DigraphWL(in);
        // StdOut.println(G);

        int s = Integer.parseInt(args[1]);
        BreadthFirstPathsWL bfs = new BreadthFirstPathsWL(G, s);
